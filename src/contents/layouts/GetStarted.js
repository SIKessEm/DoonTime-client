    ...
    <Fragment>
      <Container className="pt-5 d-flex w-100 h-100 text-center justify-content-center flex-column">
        <main>
          ...
          <p className="lead"><Link exact to="/LogIn">Log in</Link> or <Link exact to="/SignUp">sign up for free</Link> to take advantage of Doontime</p>
          <Form>
            <Row className="flex-column">
              ...
              <Col>
                <Form.Group className="m-auto mb-3 content-fit" controlId="formBasicCheckbox">
                  <Form.Check type="checkbox" label="Subscribe to the newsletter to stay informed for free" />
                </Form.Group>
              </Col>
              <Col>
